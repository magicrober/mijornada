...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primaryText = const Color(0xFF706F6F);
  late Color secondaryText = const Color(0xFF00D87A);
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFFB2B2B2);
  ...
  late Color datiumSign = const Color(0xFF75DABE);
